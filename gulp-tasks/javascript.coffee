...
gulp.task 'javascript:build', ['javascript'], ->
  ...
  collectJavaScript(files, 'angular-range-slider.js', file_manager.build, {coffee: no})
  collectJavaScript(files, 'angular-range-slider.min.js', file_manager.build, {coffee: no, compress: yes})
